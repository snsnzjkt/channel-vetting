...
# pipeline.pre_push_drop_reason(), so a channel under it is discarded before a
...
def qualify(
    ...
    check — is now a HARD gate in pipeline.pre_push_drop_reason(): a channel
    ...
    option in Airtable. airtable.client.push_record sends typecast=True,
