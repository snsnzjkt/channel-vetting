...
variant. niches.py records the rule the hard way: the biggest pool is how
...
# which reads like silent truncation. See niches.py for that measurement.
VARIANTS = {
    "Home Theater": [
        # v0 is the wording live in niches.py today — the baseline every other
