...
Read-only by default. Costs no YouTube quota.
    ...
    python scripts/audit/audit_blocklist.py            # report only
    python scripts/audit/audit_blocklist.py --mark     # also set Status to "Do Not Contact"
"""
import argparse
import logging
import sys
...
def _all_records(table_name: str) -> list[dict]:
    ...
    while True:
        ...
        # this — every other one in airtable/client.py/external_dedupe.py
