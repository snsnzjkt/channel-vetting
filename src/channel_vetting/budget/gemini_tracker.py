...
(see enrichment/email_influencers.py for the same argument). But a *daily* ceiling cannot live
...
**Deliberate duplication.** This is ~70% the shape of `budget/credit_tracker.py` and is
...
heavily commented, for the benefit of a non-money counter. See budget/credit_tracker.py
...
from channel_vetting.budget.quota_tracker import (
    PACIFIC_TZ,
    _replace_with_retry,
    today_pacific,
)
