...
any pipeline state file.
    ...
    python scripts/analysis/measure_video_topics.py                 # both niches, cached
    python scripts/analysis/measure_video_topics.py --limit 40      # cheap smoke run
    python scripts/analysis/measure_video_topics.py --refresh       # ignore the cache
"""
import argparse
import json
import os
...
CACHE_PATH = os.getenv("VIDEO_TOPICS_CACHE", data_path("video_topics_cache.json"))
