...
TRANSCRIPT_CACHE_FILE = os.getenv(
    "TRANSCRIPT_CACHE_FILE", data_path("transcript_cache.json")
)
...
def fetch(video_id: str, languages=("en",), api=None) -> str | None:
    ...
    "no transcript available" instead of breaking the import graph of pipeline.py.
