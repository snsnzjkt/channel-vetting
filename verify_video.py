...
One-shot Gemini verification probe. No discovery, no credits, no Airtable.
    ...
    python verify_video.py https://www.youtube.com/watch?v=VIDEO_ID [--duration 1800]
    python verify_video.py --niche "Home Theater" <url>

WHY THIS EXISTS. `main.py --test` runs the first niche only and needs a candidate
