...
# config, not a bare filename: this has to read the SAME cache the
# pipeline wrote, including when GEMINI_CACHE_FILE redirects it.
with open(config.GEMINI_CACHE_FILE, encoding="utf-8") as f:
    cache = json.load(f)
verdicts = {}
