...
reason pipeline.off_target_reason gives; that reason is a hypothesis until measured.
...
a re-run costs nothing.
    ...
    python scripts/analysis/measure_metadata_screen.py --limit 80     # balanced sample
    python scripts/analysis/measure_metadata_screen.py --offline      # score what is cached
"""
import argparse
import json
import os
...
CACHE_PATH = os.getenv(
    "METADATA_SCREEN_CACHE", data_path("metadata_screen_cache.json")
)
