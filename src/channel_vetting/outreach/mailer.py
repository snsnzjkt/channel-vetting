...
a future `outreach/sender.py` from doing `mailer.send(to=row["Email"])` and skipping
...
from channel_vetting.core.http_client import GMAIL as HTTP, safe_body
...
class Mailer:
    ...
    def send(self, *, to: str, subject: str, text: str, html: str) -> str:
        ...
        try:
            ...
            # reasoning enrichment/email_influencers.py applies to money, applied to something
